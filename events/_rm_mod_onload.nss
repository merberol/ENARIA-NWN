...
void main()
{
   ...
   if (GetModuleSwitchValue (MODULE_SWITCH_ENABLE_TAGBASED_SCRIPTS) == TRUE)
   {
        ...
        //SetUserDefinedItemEventPrefix("rm_");
   ...
   //NWNX_Events_SubscribeEvent("NWNX_ON_CLIENT_CONNECT_BEFORE","rm_event_conn");
   NWNX_Events_SubscribeEvent("NWNX_ON_CLIENT_DISCONNECT_BEFORE","rm_event_exit");
